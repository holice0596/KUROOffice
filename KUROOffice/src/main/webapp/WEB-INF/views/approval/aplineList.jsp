...
<!--                   <div class="table-responsive"> -->
                    <table id="zero_config" class="table table-striped table-bordered text-nowrap" style="border-color: #adabab;">
                      <thead>
                        <!-- start row -->
                        <tr>
                          ...
                          <th style="background-color: #dddddd;">긴급</th>
<!--                           <th>결재양식코드</th> -->
                        </tr>
                        <!-- end row -->
                      </thead>
								...
								<tr>
									...
									<c:choose>
                            			<c:when test="${appLineList.appTitle == '휴가신청서'}">
		                            		<td style=""><a href="/approval/vacDetail?appCode=${appLineList.appCode }&apfCode=${appLineList.apfCode}&empNo=${appLineList.empNo}">${appLineList.appTitle }</a></td>
                            	
                            			</c:when>
                            			<c:when test="${appLineList.appTitle == '채용품의서'}">
		                            		<td style=""><a href="/approval/recruitDetail?appCode=${appLineList.appCode }&apfCode=${appLineList.apfCode}&empNo=${appLineList.empNo}">${appLineList.appTitle }</a></td>
                            	
                            			</c:when>
                            		</c:choose>
									<td>${appLineList.empVO.empName }  ${appLineList.empVO.empPos }</td>
									<td>
									<c:choose>
